            ...
            ?>
                ...
                <?php
                    foreach ($conn->query($sql) as $row) {
                        ...
                        echo "<td>";
                        echo "<a class=\"btn btn-warning\" href=\"modificar_genero.php?codigo=";
                        echo $row["idGenero"]."\"><i class=\"fas fa-edit\"></i></a> ";
                        echo "<a class=\"btn btn-danger\" href=\"eliminar_genero.php?codigo=";
                        echo $row["idGenero"]."\"><i class=\"far fa-trash-alt\"></i></a>";
                        echo "</td>";
                        echo "</tr>";
                    }
