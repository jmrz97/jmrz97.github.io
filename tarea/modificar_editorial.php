  ...
  <body>
    ...
    <?php
         if(isset($_POST["submit"])){
            ...
            $sql = "UPDATE editoriales SET codigoEditorial ='$codigoEditorial', nombreEditorial='$nombreEditorial', contacto='$contacto', telefono='$telefono' WHERE codigoEditorial='$codigoEditorial' ";
