  ...
  <body>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action = "" method = "POST">
                    ...
                    <a class="btn btn-info" href="listar_generos.php">Regresar</a>
                    <br />
                </form>
            </div>
        </div>
    ...
    <?php
         if(isset($_POST["submit"])){
            ...
            $sql = "UPDATE generos SET nombreGenero='$nombreGenero', descripcion='$descripcion' WHERE idGenero='$idGenero' ";
